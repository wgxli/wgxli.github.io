import{j as e}from"./index-DFQelQQ0.js";function a(){return e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["Let ",String.raw`\(\omega := e^{i\pi/4}\)`,", and parameterize the complex plane via \\(z = r\\omega + s \\, i \\omega\\). Consider the piecewise linear contour travelling from \\(0\\) to \\(r \\omega\\), and then from \\(r \\omega\\) to \\(r \\omega + s \\, i \\omega\\). Using this contour, we compute"]}),String.raw`\[\begin{aligned}
...
//# sourceMappingURL=body-crVdAZ-f.js.map
